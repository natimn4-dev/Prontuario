...
export default async function OncogeriatricReportPage({
  ...
  const snapshotContent = {
    schemaVersion: "oncogeriatria-report-v6",
    ...
    regimenSafety: { selectedRiskFlags, commonAdverseEffects: commonAdverseEffects || null, clinicianGuidance: clinicianRegimenGuidance || null },
