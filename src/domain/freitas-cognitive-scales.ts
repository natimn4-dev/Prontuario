import type { ValidatedScaleDefinition, ValidatedScaleResult } from "./freitas-validated-scales.ts";
...
export const MINICOG_FREITAS: ValidatedScaleDefinition & { code: "minicog_freitas" } = {
...
export const MEEM_FREITAS: ValidatedScaleDefinition & { code: "meem_freitas" } = {
  code: "meem_freitas",
...
export const CLOCK_SHULMAN: ValidatedScaleDefinition & { code: "clock_shulman" } = {
  code: "clock_shulman",
...
export const MOCA_BR_FREITAS: ValidatedScaleDefinition & { code: "moca_br_freitas" } = {
...
export const IQCODE_BR_26: ValidatedScaleDefinition & { code: "iqcode_br_26" } = {
  code: "iqcode_br_26",
...
function strictAnswers(definition: ValidatedScaleDefinition, raw: Record<string, unknown>): Record<string, number> {
