...
test("atalho abre escalas em página própria, mantém episódio e permite voltar ao CARG", () => {
  ...
  assert.match(continuity, /buildOncogeriatricScalesHref/);
  assert.equal(buildOncogeriatricScalesHref({ patientId: "P1", consultationId: "Q1", episodeId: "E1" }),
    "/patients/P1/oncogeriatria/escalas?episode=E1&consultation=Q1");
