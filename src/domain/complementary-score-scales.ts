...
export const COMPLEMENTARY_SCORE_SCALES: readonly ComplementaryScoreScaleDefinition[] = [
  ...
  { code: "pps", version: LEGACY_SCORE_VERSION, name: "Palliative Performance Scale — PPS", dimension: "prognostico", instruction: "Escolha a linha que melhor combina deambulação, atividade/doença, autocuidado, ingestão e nível de consciência.", sourceNote: "Níveis discretos de 10 a 100 preservados do golden master. As faixas coloridas 70–100 / 40–60 / 10–30 são agrupamentos locais de apresentação e não estimativas individuais de sobrevida. Quando os domínios divergem, use julgamento clínico conforme o manual adotado.", fields: [{ id: "score", label: "PPS — valor e significado", choices: PPS_CHOICES }] },
  ...
  ], sourceNote: "Este modo rápido preserva uma soma global e faixas locais de apresentação; os nove sintomas devem ser revistos individualmente para decisões clínicas. As faixas do total não substituem limiares clinicamente relevantes de sintomas isolados.", fields: [scoreField(90, "Some os nove itens de 0 a 10 e informe o total de 0 a 90.")] },
] as const;
